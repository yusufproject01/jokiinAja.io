...
export default function ServicesComponent() {
  return (
    <main className="w-full h-auto sm:py-20 py-14 bg-(--bgPage) flex flex-col justify-center items-center">
      <section className="w-full flex justify-center items-center">
        <TitleCenter TitleContent="Layanan" BrandTitle="JokiinAja" />
      </section>
      <section className="w-full h-auto grid sm:grid-cols-4 grid-cols-2 justify-items-center sm:gap-x-4 gap-x-0 sm:gap-y-0 gap-y-6 pt-8 sm:pb-20 pb-12">
